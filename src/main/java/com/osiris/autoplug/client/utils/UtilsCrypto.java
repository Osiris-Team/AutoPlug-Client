...
public class UtilsCrypto {
    ...
    public static String calculateFileHash(FileChannel ch, MessageDigest d) throws IOException {
        ...
        return UtilsByte.encode(d.digest());
    }
    ...
    public static String encrypt(String key, String content) {
        try {
            return UtilsByte.encode(createAesEncryptionCipher(key).doFinal(content.getBytes(StandardCharsets.UTF_8)));
        } catch (Exception e) {
    ...
    public static String encryptBytes(String key, byte[] content) {
        try {
            return UtilsByte.encode(createAesEncryptionCipher(key).doFinal(content));
        } catch (Exception e) {
            throw new IllegalStateException("Error occurred encrypting data", e);
        }
    }
    ...
    public static String decrypt(String key, String hexStr) {
        try {
            return new String(createAesDecryptionCipher(key).doFinal(UtilsByte.decode(hexStr)));
        } catch (Exception e) {
    ...
    public static byte[] decryptBytes(String key, String hexStr) {
        try {
            return createAesDecryptionCipher(key).doFinal(UtilsByte.decode(hexStr));
        } catch (Exception e) {
            throw new IllegalStateException("Error occurred decrypting data", e);
        }
    }
